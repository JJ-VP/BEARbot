...
module.exports = {
	...
	callback: async (client, interaction) => {
		try {
			...
			const allowedTypes = ["png", "jpg", "jpeg", "avif", "webp"];
			if (allowedTypes.indexOf(extension) < 0) return interaction.reply({ content: `The filetype you surplied is not supported by this command (png, jpg, jpeg, avif, webp)`, ephemeral: true });
			...
			context.fillText(text, canvas.width / 2, canvas.height / 1.1);
